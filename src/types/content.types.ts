...
export interface About extends BasePageConfig {
  ...
  studies: {
    ...
    institutions: Array<{
      ...
      timeframe?: string;
      /** Relevant coursework — shown on experiences page */
 ...
 */
export type Blogs = BasePageConfig;
...
/**
 * Credentials page configuration.
 */
export type Credentials = BasePageConfig;

/**
 * Latest page configuration.
 */
export type Latest = BasePageConfig;
