...
import { publications, myName, PublicationType } from "./data";
...
export default function PublicationsClient() {
  ...
  const typeCounts = useMemo(
    () =>
      ALL_TYPES.reduce<Record<string, number>>((acc, t) => {
                  ...
                  {byYear[year].map((pub, pi) => (
                    <Column key={pub.title} fillWidth>
                      ...
                      <Column gap="8" className="pub-item">
                        ...
                        <Text variant="body-default-s" onBackground="neutral-weak" className="pub-authors">
