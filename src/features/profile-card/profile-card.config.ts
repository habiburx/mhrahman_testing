 ...
 * PROFILE CARD CONFIG
 *
 * Edit this file to update the profile card and footer social links.
 * Keep `essential: true` for links you want as buttons on the profile card.
 * Links with `essential: false` still appear in the footer.
 */
const person: Person = {
  ...
  avatar: "/images/profile/mhrahman.webp",
