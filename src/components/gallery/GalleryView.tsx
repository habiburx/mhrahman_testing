    ...
    <>
      ...
      <MasonryGrid columns={2} s={{ columns: 1 }}>
        {images.map((image, i) => (
          <Column
            ...
            tabIndex={0}
            // biome-ignore lint/a11y/useSemanticElements: Once UI Column provides the card layout; keyboard handlers make it operable.
            role="button"
      ...
      {lightboxIndex !== null && current && (
        <div
          ...
          // biome-ignore lint/a11y/useSemanticElements: The custom lightbox uses div layout with dialog semantics.
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <button
            type="button"
            className="lb-btn lb-arrow lb-arrow-left"
            onClick={(e) => {
              e.stopPropagation();
              prev();
            }}
          ...
          <button
            type="button"
            className="lb-btn lb-arrow lb-arrow-right"
            onClick={(e) => {
              e.stopPropagation();
              next();
            }}
